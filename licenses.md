...
| Markdown              | 3.9         | BSD-3-Clause                                                                                                                                   |
| MarkupSafe            | 3.0.3       | BSD-3-Clause                                                                                                                                   |
| PyYAML                | 6.0.3       | MIT License                                                                                                                                    |
| Werkzeug              | 3.1.3       | BSD License                                                                                                                                    |
| annotated-types       | 0.7.0       | MIT License                                                                                                                                    |
| anyio                 | 4.11.0      | MIT                                                                                                                                            |
| arabic-reshaper       | 3.0.0       | MIT                                                                                                                                            |
...
| fpdf2                 | 2.8.4       | GNU Lesser General Public License v3 (LGPLv3)                                                                                                  |
| git-remote-s3         | 0.2.5       | Apache Software License                                                                                                                        |
...
| openai                | 2.3.0       | Apache Software License                                                                                                                        |
| openpyxl              | 3.1.5       | MIT License                                                                                                                                    |
| oscrypto              | 1.3.0       | MIT License                                                                                                                                    |
...
| pyhanko-certvalidator | 0.29.0      | MIT                                                                                                                                            |
| pyparsing             | 3.2.5       | MIT                                                                                                                                            |
...
| supervisor            | 4.2.1       | BSD-derived (http://www.repoze.org/LICENSE.txt)                                                                                                |
...
| uritools              | 5.0.0       | MIT License                                                                                                                                    |
| urllib3               | 2.5.0       | MIT                                                                                                                                            |
| uvicorn               | 0.37.0      | BSD-3-Clause                                                                                                                                   |
| weasyprint            | 66.0        | BSD License                                                                                                                                    |
| webencodings          | 0.5.1       | BSD License                                                                                                                                    |
| xhtml2pdf             | 0.2.17      | Apache Software License                                                                                                                        |
